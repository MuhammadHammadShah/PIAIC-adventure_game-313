...
const startGame = async () => {
    ...
    if (door === "Door 1") {
        ...
        if (action === "Fight the lion") {
            ...
            showMessage("After a fierce battle, you defeat the lion and claim the treasure!");
        }
        else {
    ...
    showMessage("Congratulations! You have successfully completed the adventure game!", "green");
};
